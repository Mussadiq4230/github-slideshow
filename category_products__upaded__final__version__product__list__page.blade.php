...
<!-- ############################################# searching shortcuts style ################################### -->
  ...
  <link rel="stylesheet" type="text/css" href="{{asset('css/single__product.css')}}">
    ...
    <div class=" d-flex flex-wrap mx-auto justify-content-center align-items-center mt-5">
                  ...
                  <!-- option#01 -->
      <a href="" class="searching__shortcut d-flex flex-column justify-content-center align-items-center p-4 mr-3">
          <div class="searching__icons d-flex justify-content-center align-items-center">
              <!-- <i class="far fa-user fa-4x"></i> -->
              <img src="{{asset('image/icons/menLine.png')}}" alt="" style="height:100%;width:100%;">
          </div>
      ...
      <a href="" class="searching__shortcut d-flex flex-column justify-content-center align-items-center p-4 mr-3">
          <div class="searching__icons  d-flex justify-content-center align-items-center">
              <img src="{{asset('image/icons/womenLine.png')}}" alt="" style="height:100%;width:100%;">
          </div>
          <p class="mb-0 pt-3 searching__shortcuts__title text-center">Women</p>
                  ...
                  <!-- option#04 -->
      <a href="" class="searching__shortcut d-flex flex-column justify-content-center align-items-center p-4 mr-3">
          <div class="searching__icons2  d-flex justify-content-center align-items-center">
              <img src="{{asset('image/icons/boyLine.png')}}" alt="" style="height:100%;width:100%;">
          </div>
          <p class="mb-0 pt-3 searching__shortcuts__title text-center">Boy</p>
      </a>

      <!-- option#03 -->
      <a href="" class="searching__shortcut d-flex flex-column justify-content-center align-items-center p-4 mr-3">
          <div class="searching__icons  d-flex justify-content-center align-items-center">
              <img src="{{asset('image/icons/girlLine.png')}}" alt="" style="height:100%;width:100%;">
          </div>
          <p class="mb-0 pt-3 searching__shortcuts__title text-center">Girl</p>
      </a>

                                            <!-- option# baby -->
      <a href="" class="searching__shortcut d-flex flex-column justify-content-center align-items-center p-4 mr-3">
          <div class="searching__icons  d-flex justify-content-center align-items-center">
              <img src="{{asset('image/icons/babyDress.png')}}" alt="" style="height:100%;width:100%;">
              <!-- <img src="{{asset('image/icons/babyLine.png')}}" alt="" style="height:100%;width:100%;"> -->
              <!-- <i class="fas fa-baby fa-4x"></i> -->
          </div>
          <p class="mb-0 pt-3 searching__shortcuts__title text-center">Baby</p>
      </a>
      
                                              <!-- option# occasion -->
      <a href="" class="searching__shortcut d-flex flex-column justify-content-center align-items-center p-4 mr-3">
          <div class="searching__icons  d-flex justify-content-center align-items-center">
              <img src="{{asset('image/icons/occasional.png')}}" alt="" style="height:100%;width:100%;">
              <!-- <i class="fas fa-baby fa-4x"></i> -->
          </div>
          <p class="mb-0 pt-3 searching__shortcuts__title text-center">Occasion</p>
      </a>

                                              <!-- option# occasion -->
      <a href="" class="searching__shortcut d-flex flex-column justify-content-center align-items-center p-4 mr-3">
          <div class="searching__icons  d-flex justify-content-center align-items-center">
              <img src="{{asset('image/icons/color.png')}}" alt="" style="height:100%;width:100%;">
              <!-- <i class="fas fa-baby fa-4x"></i> -->
          </div>
          <p class="mb-0 pt-3 searching__shortcuts__title text-center">Colors</p>
      </a>

                                              <!-- option# occasion -->
      <a href="" class="searching__shortcut d-flex flex-column justify-content-center align-items-center p-4 mr-3">
          <div class="searching__icons  d-flex justify-content-center align-items-center">
              <img src="{{asset('image/icons/price.png')}}" alt="" style="height:100%;width:100%;">
              <!-- <i class="fas fa-baby fa-4x"></i> -->
          </div>
          <p class="mb-0 pt-3 searching__shortcuts__title text-center">Price</p>
      </a>

                                              <!-- option# occasion -->
      <a href="" class="searching__shortcut d-flex flex-column justify-content-center align-items-center p-4 mr-3">
          <div class="searching__icons  d-flex justify-content-center align-items-center">
              <img src="{{asset('image/icons/dressLength.png')}}" alt="" style="height:100%;width:100%;">
              <!-- <i class="fas fa-baby fa-4x"></i> -->
          </div>
          <p class="mb-0 pt-3 searching__shortcuts__title text-center">Dress Length</p>
      </a>

                                              <!-- option# occasion -->
      <a href="" class="searching__shortcut d-flex flex-column justify-content-center align-items-center p-4 mr-3">
          <div class="searching__icons2  d-flex justify-content-center align-items-center">
              <img src="{{asset('image/icons/sleeveLength.png')}}" alt="" style="height:100%;width:100%;">
              <!-- <i class="fas fa-baby fa-4x"></i> -->
          </div>
          <p class="mb-0 pt-3 searching__shortcuts__title text-center">Sleeve Length</p>
      </a>

                                              <!-- option# occasion -->
      <a href="" class="searching__shortcut d-flex flex-column justify-content-center align-items-center p-4 mr-3">
          <div class="searching__icons2  d-flex justify-content-center align-items-center">
              <img src="{{asset('image/icons/neckline.png')}}" alt="" style="height:100%;width:100%;">
              <!-- <i class="fas fa-baby fa-4x"></i> -->
          </div>
          <p class="mb-0 pt-3 searching__shortcuts__title text-center">Necklines</p>
      </a>
                                              <!-- option# occasion -->
      <a href="" class="searching__shortcut d-flex flex-column justify-content-center align-items-center p-4 mr-3">
          <div class="searching__icons2  d-flex justify-content-center align-items-center">
              <img src="{{asset('image/icons/pattern.png')}}" alt="" style="height:100%;width:100%;">
              <!-- <i class="fas fa-baby fa-4x"></i> -->
          </div>
          <p class="mb-0 pt-3 searching__shortcuts__title text-center">Pattern</p>
      </a>
                                              <!-- option# occasion -->
      <a href="" class="searching__shortcut d-flex flex-column justify-content-center align-items-center p-4 mr-3">
          <div class="searching__icons2  d-flex justify-content-center align-items-center">
              <img src="{{asset('image/icons/features.png')}}" alt="" style="height:100%;width:100%;">
              <!-- <i class="fas fa-baby fa-4x"></i> -->
          </div>
          <p class="mb-0 pt-3 searching__shortcuts__title text-center">Features</p>
      </a>
                                              <!-- option# occasion -->
      <a href="" class="searching__shortcut d-flex flex-column justify-content-center align-items-center p-4 mr-3">
          <div class="searching__icons2  d-flex justify-content-center align-items-center">
              <img src="{{asset('image/icons/emblishments.png')}}" alt="" style="height:100%;width:100%;">
              <!-- <i class="fas fa-baby fa-4x"></i> -->
          </div>
          <p class="mb-0 pt-3 searching__shortcuts__title text-center">Embellishments</p>
      </a>
                                              <!-- option# occasion -->
      <a href="" class="searching__shortcut d-flex flex-column justify-content-center align-items-center p-4 mr-3">
          <div class="searching__icons2  d-flex justify-content-center align-items-center">
              <img src="{{asset('image/icons/dressStyle.png')}}" alt="" style="height:100%;width:100%;">
              <!-- <i class="fas fa-baby fa-4x"></i> -->
          </div>
          <p class="mb-0 pt-3 searching__shortcuts__title text-center">Dress style</p>
      </a>
                                              <!-- option# occasion -->
      <a href="" class="searching__shortcut d-flex flex-column justify-content-center align-items-center p-4 mr-3">
          <div class="searching__icons2  d-flex justify-content-center align-items-center">
          ...
          <p class="mb-0 pt-3 searching__shortcuts__title text-center">Materials</p>
      </a>
                ...
                @foreach($products as $product)
                    ...
                    <div class="product-card mx-2 my-4">
                      ...
                      <div class="p-card-img mx-auto">
                        ...
                        <a href="" style="width:100%;height:100%"><img  src="{{asset('image/102.png')}}" alt="" style="width:100%;height:100%"></a>  
                      ...
                      <div class="infoPopUp px-3 mx-2 pt-1">
                          ...
                          <div class="product-size">
                            <span class="px-1 size">XS</span>
                            <span class="px-1 size">S</span>
                            <span class="px-1 size">M</span>                         
                            <span class="px-1 size">L</span>
                            <span class="px-1 size">XL</span>                         
                          </div>

                          <div class="product-colors d-flex justify-content-start align-items-center py-1">
                            <div class="colorArea mr-2" style="background-color:orange"></div>
                            <div class="colorArea mr-2" style="background-color:black"></div>
                            <div class="colorArea mr-2" style="background-color:blue"></div>
                            <div class="colorArea mr-2" style="background-color:green"></div>
                            <div class="colorArea mr-2" style="background-color:#DDC1B5"></div>
                            <div class="colorArea mr-2" style="background-color:#FF1F2C"></div>
                          </div>

                          <div class="product-material pt-1">
                            <!-- material heading keep it as heading -->
                            <span class="materialHeading">Material: </span> 
                            <!-- this will come from db (by product) -->
                      ...
                      <div class="productDetails px-3 mt-2">
                        ...
                        <div class="productName d-flex justify-content-start align-items-center">
                              <a href=""><span class="font-weight-bold productTitle">Colorblock Zip Up Hoodie</span></a>
                        </div>

                        <div class="productType d-flex justify-content-start align-items-start">
                            <a href=""><span class="productTypeList">Ctnmb Turtleneck Dress - BlackCtnmb Turtleneck Dress - Black Ctnmb  </span></a> 
                        </div>

                        <div class="productPrice">
                          <span class="price">$99.9</span><span class="discount pl-4">$9.99</span>
                        </div>
                        ...
                        <div class="storeInfo d-flex justify-content-start align-items-center">
                          ...
                          <div class="storeName pl-3">
                            <a class="storeTitle text-capitalize">amazon.com</a>
                          </div>
