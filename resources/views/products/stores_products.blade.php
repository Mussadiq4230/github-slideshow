...
@section('content')
 <style>
  ...
  <div class=" d-flex flex-wrap mx-auto justify-content-center align-items-center mt-5">   
      ...
      <!-- option#01 -->
      <a href="/shop/{{$selected_store->store_slug}}" class="searching__shortcut d-flex flex-column justify-content-center align-items-center p-4 mr-3">
      ...
      <!-- option#01 -->
      <a 
      @if($selected_store && $selected_store->id && $selected_store->nature =="Store")
        href="/shop/women?store%5B%5D={{$selected_store->id}}" 
      @elseif($selected_store && $selected_store->id && $selected_store->nature =="Brand")
        href="/shop/women?brand%5B%5D={{$selected_store->id}}"
      @endif

      class="searching__shortcut d-flex flex-column justify-content-center align-items-center p-4 mr-3">
          <div class="searching__icons d-flex justify-content-center align-items-center">
              <!-- <i class="far fa-user fa-4x"></i> -->
              <img src="{{asset('image/icons/women.png')}}" alt="" style="height:100%;width:100%;">
          </div>
      ...
      @if($selected_store && $selected_store->id && $selected_store->nature =="Store")
        href="/shop/men?store%5B%5D={{$selected_store->id}}" 
      @elseif($selected_store && $selected_store->id && $selected_store->nature =="Brand")
        href="/shop/men?brand%5B%5D={{$selected_store->id}}"
      @endif
      ...
      <a 
       ...
       @if($selected_store && $selected_store->id && $selected_store->nature =="Store")
        href="/shop/girls?store%5B%5D={{$selected_store->id}}" 
      @elseif($selected_store && $selected_store->id && $selected_store->nature =="Brand")
        href="/shop/girls?brand%5B%5D={{$selected_store->id}}"
      @endif 
       class="searching__shortcut d-flex flex-column justify-content-center align-items-center p-4 mr-3">
          <div class="searching__icons d-flex justify-content-center align-items-center">
              <!-- <i class="far fa-user fa-4x"></i> -->
      ...
      <a 
      @if($selected_store && $selected_store->id && $selected_store->nature =="Store")
        href="/shop/boys?store%5B%5D={{$selected_store->id}}" 
      @elseif($selected_store && $selected_store->id && $selected_store->nature =="Brand")
        href="/shop/boys?brand%5B%5D={{$selected_store->id}}"
      @endif 
      class="searching__shortcut d-flex flex-column justify-content-center align-items-center p-4 mr-3">
          <div class="searching__icons d-flex justify-content-center align-items-center">
              <!-- <i class="far fa-user fa-4x"></i> -->
      ...
      <a 
      @if($selected_store && $selected_store->id && $selected_store->nature =="Store")
        href="/shop/baby-boys?store%5B%5D={{$selected_store->id}}" 
      @elseif($selected_store && $selected_store->id && $selected_store->nature =="Brand")
        href="/shop/baby-boys?brand%5B%5D={{$selected_store->id}}"
      @endif
      ...
      <a 
       @if($selected_store && $selected_store->id && $selected_store->nature =="Store")
        href="/shop/baby-girls?store%5B%5D={{$selected_store->id}}" 
      @elseif($selected_store && $selected_store->id && $selected_store->nature =="Brand")
        href="/shop/baby-girls?brand%5B%5D={{$selected_store->id}}"
      @endif
