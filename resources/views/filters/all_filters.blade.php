    ...
    <div class="row mx-auto my-3 ">
        ...
        <div class="col-lg-4 col-md-4 col-sm-12 pl-0 pr-2">
            ...
            <div class="w-category-card-img w-100">
                <img src="{{asset('image/filters/category/casual/1.jpg')}}" alt="" style="width:100%; height:100%; object-fit: contain;">
            </div>
            <div class="w-cat-title d-flex justify-content-center align-items-center" style="">
                <span>Casual</span>
            </div>
        ...
        <div class="col-lg-8 col-md-8 col-sm-12 px-0">
            ...
            <div class="categories-list-general w-cat-type2 justify-content-start align-items-center mr-2 mt-2">
                ...
                <div class="w-category-card-img w-100">
                <img src="{{asset('image/filters/category/formal/1.jpg')}}" alt="" style="width:100%; height:100%; object-fit: contain;">
                </div>
            ...
            <div class="categories-list-general w-cat-type2 justify-content-start align-items-center mr-2 mt-2">
                    ...
                    <div class="w-category-card-img w-100">
                    <img src="{{asset('image/filters/category/cocktail/1.jpg')}}" alt="" style="width:100%; height:100%; object-fit: contain;">
                    </div>
                    <div class="w-cat-title d-flex justify-content-center align-items-center">
                    <span>Cocktail</span>
                    </div>
            ...
            <div class="categories-list-general w-cat-type2 justify-content-start align-items-center mr-2 mt-2">
                    ...
                    <div class="w-category-card-img w-100">
                    <img src="{{asset('image/filters/category/jumpsuit/1.jpg')}}" alt="" style="width:100%; height:100%; object-fit: contain;">
                    </div>
                    <div class="w-cat-title d-flex justify-content-center align-items-center">
                    <span>Jumpsuits</span>
                    </div>
            ...
            <div class="categories-list-general w-cat-type2 justify-content-start align-items-center mr-2 mt-2">
                    ...
                    <div class="w-category-card-img w-100">
                    <img src="{{asset('image/filters/category/jumper/1.jpg')}}" alt="" style="width:100%; height:100%; object-fit: contain;">
                    </div>
                    <div class="w-cat-title d-flex justify-content-center align-items-center">
                    <span>Jumper</span> 
                    </div>
