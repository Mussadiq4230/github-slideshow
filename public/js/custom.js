...
$("#product-tab2 .product_carousel_tab").owlCarousel({
        itemsCustom : [[320, 1],[600, 2],[768, 3],[992, 4],[1199, 4]],                                             
        lazyLoad : true,
        navigation : true,
        navigationText: ['<i class="fa fa-angle-left"></i>', '<i class="fa fa-angle-right"></i>'],
    ...
    $("#product-tab2 .tab_content").addClass("deactive");
    $("#product-tab2 .tab_content:first").show();
    //Default Action
